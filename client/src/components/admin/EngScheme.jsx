...
export default function EngScheme() {
  const [EngSchema, setEngSchema] = useState([]);
    ...
    function getMSchema() {
      axios
        ...
        .then((res) => {
          ...
          setEngSchema(
            results.filter((result) => result.faculty === "Engineering")
          );
        })
        .catch((err) => {
          alert(err.message);
  ...
  return (
    <div>
      <div className="mschms">
        ...
        >
          Engineering Students Marking Schema
        </h2>
